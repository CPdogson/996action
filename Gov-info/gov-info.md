...
- 我们相信行政部门的执行力，但是不排除有个别部门懒政，所以后续可以往上级部门继续申请（行政复议）如：由省级部门督促市级部门，或者走行政诉讼，借助法院的判决来督促行政部门执行。
- 信息公开申请的全部流程，包括发出申请、行政复议、诉讼、庭审记录、上诉、最后的行政回复，这些过程都是可以合法公开的（除当事人的隐私信息），就算以上所有的渠道都不能改善996问题，那也可以借助社会舆论，给懒政的部门施压，给违法的企业警示，给社会上无助者以鼓励。
- 于申请者个人而言，可以根据各地人社局回复，对比各地的用工环境，用脚投票。
